...
# TODO: If we start implementing this library (or parts of it) in Cython, change
# this to .pyx.
file_extension = '.py'
...
if os.getenv('CACHETOOLS_USE_CYTHON'):
    try:
        ...
        print(
            'The CACHETOOLS_USE_CYTHON environment variable was defined but Cython'
            " isn't installed. Package installation will proceed without it."
        )
        HAVE_CYTHON = False
else:
    HAVE_CYTHON = False
